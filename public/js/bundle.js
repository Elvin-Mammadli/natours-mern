...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFtZWRsaWVsdmluIiwiYSI6ImNsbWJ4NGR0cjE3eWkzZ3RmNWxyOGlqcWQifQ.uUXiMiEH-K7t5jWHMQUQGA';
...
var domain = "development" === 'production' ? '' : 'http://127.0.0.1:3000';
var login = function login(_x, _x2) {
  return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
    var res;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(domain, "/api/v1/users/login"),
            data: {
              email: email,
              password: password
            }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "".concat(domain, "/api/v1/users/logout")
          });
        case 3:
          res = _context2.sent;
...
var updateSettings = function updateSettings(_x, _x2) {
  return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? "".concat(domain, "/api/v1/users/updateMyPassword") : "".concat(domain, "/api/v1/users/updateMe");
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = new Stripe('pk_test_51LxPU8KatriNmqF4fnWOU5ZDMceU3uCdktwINilfSFpiM7vRpeFtLOUKNw3MddZKVMVRaW6FHl0DR5LtlxBikoXo00P69m1lpS');
var bookTour = function bookTour(_x) {
  return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', function (_x) {
